...
def length_statistic(sent_lst):
    ...
    print("total number of length larger than 512 :")
    print(len([tmp for tmp in length_lst if tmp > 512]))
    print("total number of length larger than 180 :")
    print(len([tmp for tmp in length_lst if tmp > 180]))
    print("total number of length larger than 150 :")
    print(len([tmp for tmp in length_lst if tmp > 150]))
    print("total number of length larger than 130 :")
    print(len([tmp for tmp in length_lst if tmp > 130]))
...
if __name__ == "__main__":
    data_repo = "/data/nfsdata/xiaoya/datasets/zh_tagging/pkucws"
    data_repo = "/data/nfsdata2/xiaoya/data_repo/OntoNote4NER" 
    datatype_sign = "train"
    # datatype_sign = "test"
