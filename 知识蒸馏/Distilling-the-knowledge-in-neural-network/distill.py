...
with tf.Graph().as_default():
	...
	test_acc = sess.run(accuracy_teacher,feed_dict={x:mnist.test.images, y_: mnist.test.labels, keep_prob_conv: 1.0,keep_prob_hidden: 1.0})
	print("test accuracy of the teacher model is %g "%(test_acc))
